(function (e, t) {
  ...
  function u(e) {
    ...
    } else console.error("You added a frontmatter tag but did not provide a script tag with front matter data in it. Please take a look at our templates.");
    return {};
  }
  function p(e) {
...
`;
  ...
  function x(e, t, n = document) {
    if (0 < t.size) {
      ...
      if (i) i.innerHTML = "";
        ...
        (t.innerHTML = Mi), e.appendChild(t);
  ...
  function w(e, t, n) {
    var i = (t - e) / Rn(0, n),
      ...
      d = i / Nn(10, a);
    return 0 <= a
      ? (d >= Gi ? 10 : d >= ea ? 5 : d >= ta ? 2 : 1) * Nn(10, a)
      : -Nn(10, -a) / (d >= Gi ? 10 : d >= ea ? 5 : d >= ta ? 2 : 1);
  }
  function S(e, t, n) {
    var i = Un(t - e) / Rn(0, n),
      a = Nn(10, Fn(jn(i) / In)),
  ...
  function M(e) {
    ...
    return (
      ...
      (t = sa.exec(e))
        ...
        ? new j(t[1], t[2], t[3], 1)
        : (t = pa.exec(e))
        ? new j((255 * t[1]) / 100, (255 * t[2]) / 100, (255 * t[3]) / 100, 1)
        : (t = ga.exec(e))
        ? U(t[1], t[2], t[3], t[4])
        : (t = fa.exec(e))
        ? U((255 * t[1]) / 100, (255 * t[2]) / 100, (255 * t[3]) / 100, t[4])
        : (t = ha.exec(e))
        ? R(t[1], t[2] / 100, t[3] / 100, 1)
        : (t = ba.exec(e))
        ? R(t[1], t[2] / 100, t[3] / 100, t[4])
        : ma.hasOwnProperty(e)
        ? O(ma[e])
        : "transparent" === e
        ? new j(NaN, NaN, NaN, 0)
  ...
  function O(e) {
    return new j(255 & (e >> 16), 255 & (e >> 8), 255 & e, 1);
  }
  function U(e, t, n, i) {
    return 0 >= i && (e = t = n = NaN), new j(e, t, n, i);
  }
  function N(e) {
    return (e instanceof L || (e = M(e)), !e)
      ? new j()
      : ((e = e.rgb()), new j(e.r, e.g, e.b, e.opacity));
  }
  function I(e, t, n, i) {
    return 1 === arguments.length ? N(e) : new j(e, t, n, null == i ? 1 : i);
  }
  function j(e, t, n, i) {
  ...
  function q(e) {
    ...
    if ((e instanceof L || (e = M(e)), !e)) return new F();
  ...
  function H(e) {
    ...
    if (e instanceof X) {
      var t = e.h * ya;
      return new Y(e.l, Mn(t) * e.c, Dn(t) * e.c, e.opacity);
    }
    e instanceof j || (e = N(e));
    var n = $(e.r),
      i = $(e.g),
      a = $(e.b),
  ...
  function W(e) {
    return e > Ca ? Nn(e, 1 / 3) : e / wa + Zn;
  }
  function V(e) {
    return e > va ? e * e * e : wa * (e - Zn);
  }
  function K(e) {
  ...
  function J(e) {
    ...
    var t = e.r / 255,
      n = e.g / 255,
      i = e.b / 255,
      a = (_a * i + E * t - Ta * n) / (_a + E - Ta),
      d = i - a,
      r = (D * (n - a) - B * d) / C,
      o = An(r * r + d * d) / (D * a * (1 - a)),
      l = o ? En(r, d) * xa - 120 : NaN;
  ...
  function te(e) {
    return 1 == (e = +e)
      ? ne
      : function (t, n) {
          return n - t ? ee(t, n, e) : La(isNaN(t) ? n : t);
        };
  }
  function ne(e, t) {
    var n = t - e;
    return n ? G(e, n) : La(isNaN(e) ? t : e);
  }
  function ie(e) {
    return function () {
      return e;
  ...
  function ge(e, t) {
    ...
    return (
      ...
      (i.domain = function (e) {
        return arguments.length ? ((o = aa.call(e, Ha)), n()) : o.slice();
      }),
      (i.range = function (e) {
        return arguments.length ? ((l = da.call(e)), n()) : l.slice();
      }),
      (i.rangeRound = function (e) {
        return (l = da.call(e)), (s = Ra), n();
      }),
      (i.clamp = function (e) {
  ...
  function he(e) {
    if (!(t = Xa.exec(e))) throw new Error("invalid format: " + e);
    var t,
      n = t[1] || " ",
      i = t[2] || ">",
      a = t[3] || "-",
  ...
  function be(e) {
    ...
    return (
      (e.ticks = function (e) {
        var n = t();
        return na(n[0], n[n.length - 1], null == e ? 10 : e);
      }),
      ...
      (e.nice = function (n) {
        ...
        return (
          ...
          (i = w(o, l, n)),
          0 < i
            ? ((o = Fn(o / i) * i), (l = qn(l / i) * i), (i = w(o, l, n)))
            : 0 > i &&
              ((o = qn(o * i) / i), (l = Fn(l * i) / i), (i = w(o, l, n))),
          0 < i
    ...
    return (
      ...
      n &&
        ((a.count = function (t, i) {
          return dd.setTime(+t), rd.setTime(+i), e(dd), e(rd), Fn(n(dd, rd));
        }),
        (a.every = function (e) {
          return (
            (e = Fn(e)),
  ...
  function xe(e) {
    return ye(
      ...
      function (e, t) {
        return (
          (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * sd) / pd
        );
      }
    );
  }
  ...
  function Se(e) {
    ...
    function n(e, t) {
      return function (n) {
        ...
        if (("p" in r && (r.H = (r.H % 12) + 12 * r.p), "W" in r || "U" in r)) {
          ...
          var i = "Z" in r ? we(Ce(r.y)).getUTCDay() : t(Ce(r.y)).getDay();
          (r.m = 0),
            (r.d =
              "W" in r
                ? ((r.w + 6) % 7) + 7 * r.W - ((i + 5) % 7)
        ...
        return "Z" in r
          ? ((r.H += 0 | (r.Z / 100)), (r.M += r.Z % 100), we(r))
          : t(r);
      };
    }
    function a(e, t, a, d) {
    ...
    var r = e.dateTime,
      ...
      S = {
        ...
        b: function (e, t, a) {
          var i = v.exec(t.slice(a));
          return i ? ((e.m = w[i[0].toLowerCase()]), a + i[0].length) : -1;
        },
        B: function (e, t, a) {
  ...
  function Ee(e, t, a) {
    var i = zd.exec(t.slice(a, a + 1));
    return i ? ((e.w = +i[0]), a + i[0].length) : -1;
  }
  function De(e, t, a) {
    var i = zd.exec(t.slice(a));
  ...
  function Oe(e, t, a) {
    var i = zd.exec(t.slice(a, a + 4));
    return i ? ((e.y = +i[0]), a + i[0].length) : -1;
  }
  function Ue(e, t, a) {
    var i = zd.exec(t.slice(a, a + 2));
    return i
  ...
  function Ve(e, t) {
    return Te(1 + bd.count(Td(e), e), t, 3);
  }
  function Ke(e, t) {
  ...
  function Qe(e, t) {
    return Te(md.count(Td(e), e), t, 2);
  }
  function Ze(e) {
    return e.getDay();
  }
  function Ge(e, t) {
    return Te(yd.count(Td(e), e), t, 2);
  }
  function et(e, t) {
  ...
  function rt(e, t) {
    return Te(1 + Ad.count(Rd(e), e), t, 3);
  }
  function ot(e, t) {
  ...
  function ut(e, t) {
    return Te(Ed.count(Rd(e), e), t, 2);
  }
  function pt(e) {
    return e.getUTCDay();
  }
  function gt(e, t) {
    return Te(Dd.count(Rd(e), e), t, 2);
  }
  function ft(e, t) {
  ...
  function Ct(e, t, a) {
    for (var d = 0, i = e.length; d < i; ++d)
      if (e[d].name === t) {
        (e[d] = tr), (e = e.slice(0, d).concat(e.slice(d + 1)));
        break;
      }
  ...
  function St(e) {
    return function () {
      var t = this.ownerDocument,
        n = this.namespaceURI;
      return n === nr && t.documentElement.namespaceURI === nr
        ? t.createElement(e)
  ...
  function Dt(e, t, n) {
    var a = cr.hasOwnProperty(e.type) ? _t : Lt;
  ...
  function jt(e, t, n, a, d, r, o) {
    ...
    for (l = 0; l < u; ++l)
      (i = t[l]) &&
        ((g[l] = s = kr + o.call(i, i.__data__, l, t)),
        s in c ? (d[l] = i) : (c[s] = i));
    for (l = 0; l < p; ++l)
      (s = kr + o.call(e, r[l], l, r)),
        (i = c[s])
  ...
  function Kt(e, t) {
    return (
      ...
      vr(e).getComputedStyle(e, null).getPropertyValue(t)
    );
  }
  function $t(e) {
    return function () {
  ...
  function kn() {
    ur.stopImmediatePropagation();
  }
  function vn(e, t) {
    var n = e.document.documentElement,
      i = Cr(e).on("dragstart.drag", null);
    t &&
      (i.on("click.drag", Tr, !0),
      setTimeout(function () {
  ...
  function wn(e, t, n, i, a, d, r, o, l, s) {
    (this.target = e),
      (this.type = t),
      (this.subject = n),
      (this.identifier = i),
  ...
  function Ln(e) {
    ...
    <pre class="citation short">${e.concatenatedAuthors}, "${
          e.title
        }", Distill, ${e.publishedYear}.</pre>
    <p>BibTeX citation</p>
  ...
  const ii = function (e, t, n) {
        ...
        if ("text" === e[d].type) {
          ...
          for (
            ...
            if (l) {
              ...
              if (((o = ii(n, r, s + t.length)), -1 === o)) break;
              a.push({
                type: "math",
    ...
    di = function (e, t) {
      ...
      for (let a = 0; a < t.length; a++) {
        const e = t[a];
        n = ai(n, e.left, e.right, e.display || !1);
      }
      return n;
    },
    ri = function (e, t) {
      const n = di(e, t.delimiters),
...
`
  ...
  class T extends ei(ui(HTMLElement)) {
    ...
    static katexLoadedCallback() {
      ...
      T.katexOptions.delimiters && si(document.body, T.katexOptions);
    }
    static addKatex() {
      document.head.insertAdjacentHTML("beforeend", ci);
  ...
  const fi = new Gn(),
    hi = {
      ...
      listeners: {
        onCiteKeyCreated(e) {
          const [t, n] = e.detail;
          if (!fi.citationsCollected)
            return void hi.waitingOn.citations.push(() =>
              hi.listeners.onCiteKeyCreated(e)
            );
          if (!fi.bibliographyParsed)
            return void hi.waitingOn.bibliography.push(() =>
              hi.listeners.onCiteKeyCreated(e)
            );
          const i = n.map((e) => fi.citations.indexOf(e));
          t.numbers = i;
          const a = n.map((e) => fi.bibliography.get(e));
          t.entries = a;
        },
        onCiteKeyChanged() {
          (fi.citations = t()), (fi.citationsCollected = !0);
          for (const e of hi.waitingOn.citations.slice()) e();
          const e = document.querySelector("d-citation-list"),
            n = new Map(
              fi.citations.map((e) => {
                return [e, fi.bibliography.get(e)];
              })
            );
          e.citations = n;
          ...
          for (const e of i) {
            const t = e.keys,
              n = t.map((e) => fi.citations.indexOf(e));
            e.numbers = n;
            const i = t.map((e) => fi.bibliography.get(e));
            e.entries = i;
          }
        },
        onCiteKeyRemoved(e) {
          hi.listeners.onCiteKeyChanged(e);
        },
        onBibliographyChanged(e) {
          const t = document.querySelector("d-citation-list"),
            n = e.detail;
          (fi.bibliography = n), (fi.bibliographyParsed = !0);
          for (const t of hi.waitingOn.bibliography.slice()) t();
          if (!fi.citationsCollected)
            return void hi.waitingOn.citations.push(function () {
              hi.listeners.onBibliographyChanged({
                target: e.target,
                detail: e.detail,
              });
            });
        ...
        onFrontMatterChanged(t) {
          ...
          i &&
            ("undefined" == typeof fi.password
              ? i.parentElement.removeChild(i)
              : (i.password = fi.password));
          ...
          if (!a && s()) {
            ...
            t && (t.frontMatter = fi), n.katex && (T.katexOptions = n.katex);
          }
        },
        DOMContentLoaded() {
          if (hi.loaded)
          ...
          const e = document.querySelector("d-front-matter"),
            n = u(e);
          hi.listeners.onFrontMatterChanged({ detail: n }),
            (fi.citations = t()),
            (fi.citationsCollected = !0);
          for (const e of hi.waitingOn.citations.slice()) e();
          if (fi.bibliographyParsed)
            for (const e of hi.waitingOn.bibliography.slice()) e();
  ...
  class yi {
    static browserSupportsAllFeatures() {
      return mi.every((e) => e.support());
    }
    static load(e) {
      const t = function (t) {
        (t.loaded = !0),
          console.debug("Runlevel 0: Polyfill has finished loading: " + t.name),
          yi.neededPolyfills.every((e) => e.loaded) &&
            (console.debug(
      ...
      for (const n of yi.neededPolyfills) g(n, t);
    }
    static get neededPolyfills() {
      return (
        yi._neededPolyfills ||
          (yi._neededPolyfills = mi.filter((e) => !e.support())),
        yi._neededPolyfills
      );
    }
  }
...
`
  ...
  class ki extends xi(HTMLElement) {}
  const vi = ti(
    "d-appendix",
    `
<style>
...
`,
  ...
  class wi extends vi(HTMLElement) {}
  const Ci = /^\s*$/;
...
`
  ...
  class Di extends Ei(HTMLElement) {
    constructor() {
...
`;
  ...
  var Ui = f(function (e) {
                    ...
                    for (
                      ...
                      if (!(y instanceof n)) {
                        ...
                        var v = c.exec(y),
                          w = 1;
                        if (!v && f && x != d.length - 1) {
                          if (((c.lastIndex = i), (v = c.exec(e)), !v)) break;
                          for (
                            var C = v.index + (g ? v[1].length : 0),
                        ...
                        if (v) {
                          ...
                          var C = v.index + h,
                            ...
                            A = [x, w];
                          _ && A.push(_);
                          var E = new n(o, u ? a.tokenize(v, u) : v, b, v, f);
                          A.push(E),
                            L && A.push(L),
    ...
    e.exports && (e.exports = n),
      "undefined" != typeof Ti && (Ti.Prism = n),
      (n.languages.markup = {
        comment: /<!--[\w\W]*?-->/,
        prolog: /<\?[\w\W]+?\?>/,
...
`
  ...
  class Ii extends ei(Ni(HTMLElement)) {
    renderContent() {
      if (
      ...
      const e = Ui.languages[this.languageName];
      if (void 0 == e)
        return void console.warn(
...
`
  ...
  class Ri extends ji(HTMLElement) {
    constructor() {
      super();
    ...
    connectedCallback() {
      (this.hoverBox = this.root.querySelector("d-hover-box")),
        ...
        (Ri.currentFootnoteId += 1);
      const e = Ri.currentFootnoteId.toString();
...
`,
  ...
  class Bi extends Yi(HTMLElement) {}
  ...
  class Vi extends HTMLElement {
    ...
    static get readyQueue() {
      return Vi._readyQueue || (Vi._readyQueue = []), Vi._readyQueue;
    }
    static addToReadyQueue(e) {
      -1 === Vi.readyQueue.indexOf(e) &&
        (Vi.readyQueue.push(e), Vi.runReadyQueue());
    }
    static runReadyQueue() {
      const e = Vi.readyQueue
        .sort((e, t) => e._seenOnScreen - t._seenOnScreen)
        .filter((e) => !e._ready)
        .pop();
      e && (e.ready(), requestAnimationFrame(Vi.runReadyQueue));
    }
    constructor() {
      super(),
        (this._ready = !1),
    ...
    connectedCallback() {
      (this.loadsWhileScrolling = this.hasAttribute("loadsWhileScrolling")),
        Vi.marginObserver.observe(this),
        Vi.directObserver.observe(this);
    }
    disconnectedCallback() {
      Vi.marginObserver.unobserve(this), Vi.directObserver.unobserve(this);
    }
    static get marginObserver() {
      if (!Vi._marginObserver) {
        const e = window.innerHeight,
          t = Fn(2 * e),
          n = Vi.didObserveMarginIntersection,
          i = new IntersectionObserver(n, {
            rootMargin: t + "px 0px " + t + "px 0px",
            threshold: 0.01,
          });
        Vi._marginObserver = i;
      }
      return Vi._marginObserver;
    }
    static didObserveMarginIntersection(e) {
      for (const t of e) {
        const e = t.target;
        t.isIntersecting && !e._ready && Vi.addToReadyQueue(e);
      }
    }
    static get directObserver() {
      return (
        Vi._directObserver ||
          (Vi._directObserver = new IntersectionObserver(
            Vi.didObserveDirectIntersection,
    ...
    addEventListener(e, t) {
      super.addEventListener(e, t),
        "ready" === e &&
          -1 !== Vi.readyQueue.indexOf(this) &&
          ((this._ready = !1), Vi.runReadyQueue()),
        "onscreen" === e && this.onscreen();
    }
    ready() {
      (this._ready = !0), Vi.marginObserver.unobserve(this);
    ...
    window.addEventListener(
      ...
      () => {
        (Vi.isScrolling = !0),
          clearTimeout(e),
          (e = setTimeout(() => {
            (Vi.isScrolling = !1), Vi.runReadyQueue();
          }, 500));
      },
      !0
    );
...
`
  ...
  class $i extends Ki(HTMLElement) {
    connectedCallback() {
  ...
  var Xi = function (e, t) {
    ...
    Zi = function (e, t, a) {
      ...
      for (var d = -1, i = 0 | Rn(0, qn((t - e) / a)), n = Array(i); ++d < i; )
        n[d] = e + d * a;
      return n;
    },
    Gi = 7.0710678118654755,
    ea = 3.1622776601683795,
    ta = 1.4142135623730951,
    na = function (e, t, a) {
      var d,
        r,
        n,
    ...
    ra(
      ...
      _(L, {
        ...
        toString: function () {
          var e = this.opacity;
          return (
            (e = isNaN(e) ? 1 : Rn(0, Hn(1, e))),
            (1 === e ? "rgb(" : "rgba(") +
              Rn(0, Hn(255, Pn(this.r) || 0)) +
              ", " +
              Rn(0, Hn(255, Pn(this.g) || 0)) +
              ", " +
              Rn(0, Hn(255, Pn(this.b) || 0)) +
              (1 === e ? ")" : ", " + e + ")")
          );
        },
      })
  ...
  ra(
    ...
    _(L, {
      ...
      rgb: function () {
        var e = isNaN(this.h) ? 0 : (this.h + 120) * ya,
          t = +this.l,
  ...
  var La = function (e) {
    ...
    Ua = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
    Na = new RegExp(Ua.source, "g"),
    Ia = function (e, n) {
      var t,
        a,
        d,
        r = (Ua.lastIndex = Na.lastIndex = 0),
        o = -1,
        l = [],
        s = [];
      for (e += "", n += ""; (t = Ua.exec(e)) && (a = Na.exec(n)); )
        (d = a.index) > r &&
    ...
    $a = {
      ...
      s: function (e, t) {
        ...
        return l === i
          ...
          : "0." + Array(1 - l).join("0") + Ya(e, Rn(0, t + l - 1))[0];
      },
      X: function (e) {
  ...
  (fe.prototype = he.prototype),
    (he.prototype.toString = function () {
      return (
        ...
        this.symbol +
        (this.zero ? "0" : "") +
        (null == this.width ? "" : Rn(1, 0 | this.width)) +
        (this.comma ? "," : "") +
        (null == this.precision ? "" : "." + Rn(0, 0 | this.precision)) +
        this.type
      );
    });
  var re,
    ...
    ed = function (e) {
      function t(e) {
        function t(e) {
          ...
          g && !u && (e = a(e, Infinity));
          var w = c.length + e.length + k.length,
            C = w < p ? Array(p - w + 1).join(o) : "";
          switch (
            (g &&
              u &&
            ...
            case "=":
              ...
              break;
            case "^":
              e = C.slice(0, (w = C.length >> 1)) + c + e + k + C.slice(w);
              break;
            default:
              e = C + c + e + k;
          }
      ...
      var a = e.grouping && e.thousands ? Wa(e.grouping, e.thousands) : Za,
        n = e.currency,
        d = e.decimal,
        r = e.numerals ? Va(e.numerals) : Za,
        i = e.percent || "%";
      return {
        format: t,
        formatPrefix: function (n, i) {
          var a = t(((n = fe(n)), (n.type = "f"), n)),
            d = 3 * Rn(-8, Hn(8, Fn(Ba(i) / 3))),
            r = Nn(10, -d),
            o = Ga[8 + d / 3];
          return function (e) {
            return a(r * e) + o;
  ...
  (function (e) {
    return (re = ed(e)), (Ja = re.format), (Qa = re.formatPrefix), re;
  })({ decimal: ".", thousands: ",", grouping: [3], currency: ["$", ""] });
  var td = function (e) {
      return Rn(0, -Ba(Un(e)));
    },
    nd = function (e, t) {
      return Rn(0, 3 * Rn(-8, Hn(8, Fn(Ba(t) / 3))) - Ba(Un(e)));
    },
    id = function (e, t) {
      return (e = Un(e)), (t = Un(t) - e), Rn(0, Ba(t) - Ba(e)) + 1;
    },
    ad = function (e, t, n) {
      var i,
        a = e[0],
      ...
      switch (((n = fe(null == n ? ",f" : n)), n.type)) {
        case "s": {
          var o = Rn(Un(a), Un(d));
          return (
            null != n.precision || isNaN((i = nd(r, o))) || (n.precision = i),
            Qa(n, o)
          );
        }
        case "":
  ...
  var ld = 1e3,
    ...
    hd = ye(
      function (e) {
        var t = (e.getTimezoneOffset() * sd) % cd;
        0 > t && (t += cd), e.setTime(Fn((+e - t) / cd) * cd + t);
      },
      function (e, t) {
        e.setTime(+e + t * cd);
      },
    ...
    bd = ye(
      ...
      function (e, t) {
        return (
          (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * sd) / ud
        );
      },
      function (e) {
        return e.getDate() - 1;
  ...
  var qd,
    ...
    Bd = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g;
  (function (e) {
    return (qd = Se(e)), (Fd = qd.utcFormat), (Pd = qd.utcParse), qd;
  })({
    dateTime: "%x, %X",
    date: "%-m/%-d/%Y",
    time: "%-I:%M:%S %p",
  ...
  var Wd = "%Y-%m-%dT%H:%M:%S.%LZ",
    Vd = Date.prototype.toISOString
      ? function (e) {
          return e.toISOString();
        }
      : Fd(Wd),
    Kd = +new Date("2000-01-01T00:00:00.000Z")
      ? function (e) {
          var t = new Date(e);
  ...
  $d("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
    $d(
    ...
    Fa(Q(300, 0.5, 0), Q(-240, 0.5, 1));
  var Xd = Fa(Q(-100, 0.75, 0.35), Q(80, 1.5, 0.8)),
    Jd = Fa(Q(260, 0.75, 0.35), Q(80, 1.5, 0.8)),
    Qd = Q();
  yt(
    $d(
  ...
  kt.prototype = xt.prototype = {
    ...
    on: function (e, a) {
      ...
      if (2 > arguments.length) {
        for (; ++o < i; )
          if ((d = (e = r[o]).type) && (d = wt(t[d], e.name))) return d;
        return;
      }
  ...
  var nr = "http://www.w3.org/1999/xhtml",
    ...
    ar = function (e) {
      ...
      return (
        ...
        ir.hasOwnProperty(t) ? { space: ir[t], local: e } : e
      );
    },
    dr = function (e) {
      var t = ar(e);
  ...
  var sr = rr,
    ...
    ur = null;
  if ("undefined" != typeof document) {
    var pr = document.documentElement;
    "onmouseenter" in pr ||
      (cr = { mouseenter: "mouseover", mouseleave: "mouseout" });
  }
  var gr = function () {
      for (var e, t = ur; (e = t.sourceEvent); ) t = e;
      return t;
    },
    fr = function (e, t) {
    ...
    hr = function (e) {
      var t = gr();
      return t.changedTouches && (t = t.changedTouches[0]), fr(e, t);
    },
    br = function (e) {
      return null == e
        ? Ot
  ...
  xn.prototype = function () {
    return new xn([[document.documentElement]], wr);
  }.prototype = {
    constructor: xn,
    select: function (e) {
      "function" != typeof e && (e = br(e));
    ...
    data: function (e, t) {
      ...
      for (
        ...
        var c = i[s],
          ...
          m = (l[s] = Array(p));
        n(c, u, h, b, m, g, t);
        for (var y, x, k = 0, v = 0; k < f; ++k)
          if ((y = h[k])) {
            for (k >= v && (v = k + 1); !(x = b[v]) && ++v < f; );
            y._next = x || null;
          }
      }
    ...
    enter: function () {
      return new xn(this._enter || this._groups.map(yr), this._parents);
    },
    exit: function () {
      return new xn(this._exit || this._groups.map(yr), this._parents);
    },
    merge: function (e) {
      for (
        var t = this._groups,
    ...
    append: function (e) {
      var t = "function" == typeof e ? e : dr(e);
      return this.select(function () {
        return this.appendChild(t.apply(this, arguments));
      });
    },
    insert: function (e, t) {
      var n = "function" == typeof e ? e : dr(e),
        i = null == t ? fn : "function" == typeof t ? t : br(t);
      return this.select(function () {
  ...
  var Cr = function (e) {
    ...
    Sr = function (e, t, a) {
      3 > arguments.length && ((a = t), (t = gr().changedTouches));
      for (var d, r = 0, i = t ? t.length : 0; r < i; ++r)
        if ((d = t[r]).identifier === a) return fr(e, d);
      return null;
    },
    Tr = function () {
      ur.preventDefault(), ur.stopImmediatePropagation();
    },
    _r = function (e) {
      var t = e.document.documentElement,
        n = Cr(e).on("dragstart.drag", Tr, !0);
      "onselectstart" in t
        ? n.on("selectstart.drag", Tr, !0)
  ...
  var Ar = function () {
    ...
    function t() {
      if (!u && p.apply(this, arguments)) {
        var e = o("mouse", g.apply(this, arguments), hr, this, arguments);
        e &&
          (Cr(ur.view).on("mousemove.drag", n, !0).on("mouseup.drag", i, !0),
          _r(ur.view),
          kn(),
          (c = !1),
          (l = ur.clientX),
    ...
    function i() {
      Cr(ur.view).on("mousemove.drag mouseup.drag", null),
        vn(ur.view, c),
        Tr(),
        b.mouse("end");
    }
    function a() {
      if (p.apply(this, arguments)) {
        var e,
          ...
          d = i.length;
        for (e = 0; e < d; ++e)
          (t = o(i[e].identifier, a, Sr, this, arguments)) &&
            (kn(), t("start"));
      }
    }
    function d() {
      var e,
        ...
        i = ur.changedTouches,
        a = i.length;
      for (e = 0; e < a; ++e) (t = b[i[e].identifier]) && (Tr(), t("drag"));
    }
    function r() {
      var e,
        t,
    ...
    function o(t, i, a, d, r) {
      var o,
        ...
        u = m.copy();
      return Mt(
        new wn(e, "beforestart", o, t, y, c[0], c[1], 0, 0, u),
        function () {
          return (
            null != (ur.subject = o = f.apply(d, r)) &&
    ...
    return (
      (e.filter = function (t) {
        return arguments.length
          ? ((p = "function" == typeof t ? t : Lr(!!t)), e)
          : p;
      }),
      (e.container = function (t) {
        return arguments.length
          ? ((g = "function" == typeof t ? t : Lr(t)), e)
          : g;
      }),
      (e.subject = function (t) {
        return arguments.length
          ? ((f = "function" == typeof t ? t : Lr(t)), e)
          : f;
      }),
      (e.touchable = function (t) {
        return arguments.length
          ? ((h = "function" == typeof t ? t : Lr(!!t)), e)
          : h;
      }),
      (e.on = function () {
...
`
  ...
  class Mr extends Er(HTMLElement) {
    connectedCallback() {
      (this.connected = !0),
      ...
      "any" !== this.step && (t = this.quantizeValue(e, this.step)),
        ...
        this.connected &&
          ...
          (this.trackFill.style.width =
            100 * this.scale(this.min + Un(t - this.origin)) + "%"),
      ...
      if (!1 !== this.ticks) {
        ...
        (t =
          0 < this.ticks
            ...
            : "any" === this.step
            ? this.scale.ticks()
            : Zi(this.min, this.max + 1e-6, this.step)),
          t.forEach((t) => {
...
`,
    Nr = ti("distill-header", Ur, !1);
  class Ir extends Nr(HTMLElement) {}
  const jr = `
<style>
  distill-appendix {
    contain: layout style;
...
`,
  ...
  const Hr = function () {
    ...
    p(document),
      ...
      (window.distillRunlevel += 1);
    for (const [e, t] of Object.entries(hi.listeners))
      "function" == typeof t
